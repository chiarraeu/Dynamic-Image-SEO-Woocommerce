...
/**
 * Checks if the 'Alt_seo' option exists in WordPress.
 * If not, sets a default configuration for this option.
 */
function Alt_seo_check_for_existing_settings(): void {
